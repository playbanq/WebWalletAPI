...
## Abstract
This specification defines a REST API (application programming interface) that aims to enable web applications to carry out electronic commerce transactions using WebWallets.
